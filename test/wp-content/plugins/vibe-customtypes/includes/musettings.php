	...
	function lms_general_settings(){
		...
		switch($_GET['sub']){
			...
			default:
				...
				array(
						'label' => __('Open Login popup for non logged in users when they click on take this course button','vibe-customtypes'),
	...
	*/
	...
	function lms_addons(){
		...
		$addons = apply_filters('wplms_lms_addons',array(
			'wplms-clp' =>array(
					'label'=> __('Custom Learning Paths','vibe-customtypes'),
					'sub'=> __('Custom Learning Paths for WPLMS','vibe-customtypes'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_clp_license_key',
					'link' => 'http://vibethemes.com/downloads/custom-learning-paths/',
					'extra'=>array('Custom Learning Paths','Certificates & Badges','Points/Credits based system'),
