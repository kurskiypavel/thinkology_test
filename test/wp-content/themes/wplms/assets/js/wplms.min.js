...
+function (t) {
    ...
    n.VERSION = "3.3.7", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        var u = /top|bottom/.test(n), p = u ? 2 * d.left - o + l : 2 * d.top - s + c,
    ...
    t.flexslider = function (n, i) {
        ...
        var s, a = o.vars.namespace, r = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            l = ("ontouchstart" in window || r || window.DocumentTouch && document instanceof DocumentTouch) && o.vars.touch,
            c = "click touchend MSPointerUp keyup", d = "", u = "vertical" === o.vars.direction, p = o.vars.reverse,
            h = o.vars.itemWidth > 0, f = "fade" === o.vars.animation, m = "" !== o.vars.asNavFor, g = {};
        t.data(n, "flexslider", o), g = {
            init: function () {
                ...
                setup: function () {
                    o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(a + "active-slide").eq(o.currentItem).addClass(a + "active-slide"), r ? (n._slider = o, o.slides.each(function () {
                        var e = this;
                        ...
                        s <= 0 && n.hasClass(a + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : t(o.vars.asNavFor).data("flexslider").animating || n.hasClass(a + "active-slide") || (o.direction = o.currentItem < i ? "next" : "prev", o.flexAnimate(i, o.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            }, controlNav: {
                setup: function () {
                    ...
                    if (o.controlNavScaffold = t('<ol class="' + a + "control-nav " + a + i + '"></ol>'), o.pagingCount > 1)for (var r = 0; r < o.pagingCount; r++) {
                        n = o.slides.eq(r), void 0 === n.attr("data-thumb-alt") && n.attr("data-thumb-alt", "");
                        var l = "" !== n.attr("data-thumb-alt") ? l = ' alt="' + n.attr("data-thumb-alt") + '"' : "";
                        if (e = "thumbnails" === o.vars.controlNav ? '<img src="' + n.attr("data-thumb") + '"' + l + "/>" : '<a href="#">' + s + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
                ...
                setup: function () {
                    ...
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + a + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + a + "direction-nav li a", o)), g.directionNav.update(), o.directionNav.bind(c, function (e) {
                        e.preventDefault();
                        var n;
                        "" !== d && d !== e.type || (n = t(this).hasClass(a + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(n, o.vars.pauseOnAction)), "" === d && (d = e.type), g.setToClearWatchedEvent()
                    })
                }, update: function () {
                    var t = a + "disabled";
                ...
                setup: function () {
                    ...
                    o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + a + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + a + "pauseplay a", o)), g.pausePlay.update(o.vars.slideshow ? a + "pause" : a + "play"), o.pausePlay.bind(c, function (e) {
                        e.preventDefault(), "" !== d && d !== e.type || (t(this).hasClass(a + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === d && (d = e.type), g.setToClearWatchedEvent()
                    })
                }, update: function (t) {
                ...
                function t(t) {
                    t.stopPropagation(), o.animating ? t.preventDefault() : (o.pause(), n._gesture.addPointer(t.pointerId), _ = 0, c = u ? o.h : o.w, m = Number(new Date), l = h && p && o.animatingTo === o.last ? 0 : h && p ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : h && o.currentSlide === o.last ? o.limit : h ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : p ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c)
                }
                ...
                function e(t) {
                    ...
                    if (e) {
                        ...
                        return _ += u ? o : i, d = _, b = u ? Math.abs(_) < Math.abs(-i) : Math.abs(_) < Math.abs(-o), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            n._gesture.stop()
                        }) : void((!b || Number(new Date) - m > 500) && (t.preventDefault(), !f && e.transitions && (e.vars.animationLoop || (d = _ / (0 === e.currentSlide && _ < 0 || e.currentSlide === e.last && _ > 0 ? Math.abs(_) / c + 2 : 1)), e.setProps(l + d, "setTouch"))))
                    }
                }
                ...
                function i(t) {
                    ...
                    var e = t.target._slider;
                    if (e) {
                        if (e.animatingTo === e.currentSlide && !b && null !== d) {
                            var n = p ? -d : d, i = n > 0 ? e.getTarget("next") : e.getTarget("prev");
                            e.canAdvance(i) && (Number(new Date) - m < 550 && Math.abs(n) > 50 || Math.abs(n) > c / 2) ? e.flexAnimate(i, e.vars.pauseOnAction) : f || e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0)
                        }
                        s = null, a = null, d = null, l = null, _ = 0
                    }
                }

                var s, a, l, c, d, m, g, v, y, b = !1, w = 0, C = 0, _ = 0;
                r ? (n.style.msTouchAction = "none", n._gesture = new MSGesture, n._gesture.target = n, n.addEventListener("MSPointerDown", t, !1), n._slider = o, n.addEventListener("MSGestureChange", e, !1), n.addEventListener("MSGestureEnd", i, !1)) : (g = function (t) {
                    o.animating ? t.preventDefault() : (window.navigator.msPointerEnabled || 1 === t.touches.length) && (o.pause(), c = u ? o.h : o.w, m = Number(new Date), w = t.touches[0].pageX, C = t.touches[0].pageY, l = h && p && o.animatingTo === o.last ? 0 : h && p ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : h && o.currentSlide === o.last ? o.limit : h ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : p ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c, s = u ? C : w, a = u ? w : C, n.addEventListener("touchmove", v, !1), n.addEventListener("touchend", y, !1))
                }, v = function (t) {
                    w = t.touches[0].pageX, C = t.touches[0].pageY, d = u ? s - C : s - w, b = u ? Math.abs(d) < Math.abs(w - a) : Math.abs(d) < Math.abs(C - a);
                    var e = 500;
                    (!b || Number(new Date) - m > e) && (t.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (d /= 0 === o.currentSlide && d < 0 || o.currentSlide === o.last && d > 0 ? Math.abs(d) / c + 2 : 1), o.setProps(l + d, "setTouch")))
                }, y = function (t) {
                    if (n.removeEventListener("touchmove", v, !1), o.animatingTo === o.currentSlide && !b && null !== d) {
                        var e = p ? -d : d, i = e > 0 ? o.getTarget("next") : o.getTarget("prev");
                        o.canAdvance(i) && (Number(new Date) - m < 550 && Math.abs(e) > 50 || Math.abs(e) > c / 2) ? o.flexAnimate(i, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                    }
                    n.removeEventListener("touchend", y, !1), s = null, a = null, d = null, l = null
                }, n.addEventListener("touchstart", g, !1))
            }, resize: function () {
                !o.animating && o.is(":visible") && (h || o.doMath(), f ? g.smoothHeight() : h ? (o.slides.width(o.computedW), o.update(o.pagingCount), o.setProps()) : u ? (o.viewport.height(o.h), o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && g.smoothHeight(), o.newSlides.width(o.computedW), o.setProps(o.computedW, "setTotal")))
        ...
        }, o.flexAnimate = function (e, n, i, s, r) {
            if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), m && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, r) || i) && o.is(":visible")) {
                if (m && s) {
                    var c = t(o.vars.asNavFor).data("flexslider");
                    if (o.atEnd = 0 === e || e === o.count - 1, c.flexAnimate(e, !0, !1, !0, r), o.direction = o.currentItem < e ? "next" : "prev", c.direction = o.direction, Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e)return o.currentItem = e, o.slides.removeClass(a + "active-slide").eq(e).addClass(a + "active-slide"), !1;
                ...
                if (o.animating = !0, o.animatingTo = e, n && o.pause(), o.vars.before(o), o.syncExists && !r && g.sync("animate"), o.vars.controlNav && g.controlNav.active(), h || o.slides.removeClass(a + "active-slide").eq(e).addClass(a + "active-slide"), o.atEnd = 0 === e || e === o.last, o.vars.directionNav && g.directionNav.update(), e === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), f) l ? (o.slides.eq(o.currentSlide).css({
                    ...
                    opacity: 1,
                    zIndex: 2
                }), o.wrapup(b)) : (o.slides.eq(o.currentSlide).css({zIndex: 1}).animate({opacity: 0}, o.vars.animationSpeed, o.vars.easing), o.slides.eq(e).css({zIndex: 2}).animate({opacity: 1}, o.vars.animationSpeed, o.vars.easing, o.wrapup)); else {
            ...
            var i = function () {
                var n = t ? t : (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo, i = function () {
                    if (h)return "setTouch" === e ? t : p && o.animatingTo === o.last ? 0 : p ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : o.animatingTo === o.last ? o.limit : n;
                    switch (e) {
                        case"setTotal":
            ...
            o.transitions && (i = u ? "translate3d(0," + i + ",0)" : "translate3d(" + i + ",0,0)", n = void 0 !== n ? n / 1e3 + "s" : "0s", o.container.css("-" + o.pfx + "-transition-duration", n), o.container.css("transition-duration", n)), o.args[o.prop] = i, (o.transitions || void 0 === n) && o.container.css(o.args), o.container.css("transform", i)
        }, o.setup = function (e) {
            if (f) o.slides.css({
                width: "100%",
                float: "left",
                ...
                "init" === e && (o.viewport = t('<div class="' + a + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(o).append(o.container), o.cloneCount = 0, o.cloneOffset = 0, p && (i = t.makeArray(o.slides).reverse(), o.slides = t(i), o.container.empty().append(o.slides))), o.vars.animationLoop && !h && (o.cloneCount = 2, o.cloneOffset = 1, "init" !== e && o.container.find(".clone").remove(), o.container.append(g.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(g.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))), o.newSlides = t(o.vars.selector, o), n = p ? o.count - 1 - o.currentSlide + o.cloneOffset : o.currentSlide + o.cloneOffset, u && !h ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
            ...
            o.w = void 0 === o.viewport ? o.width() : o.viewport.width(), o.h = t.height(), o.boxPadding = t.outerWidth() - t.width(), h ? (o.itemT = o.vars.itemWidth + e, o.itemM = e, o.minW = n ? n * o.itemT : o.w, o.maxW = i ? i * o.itemT - e : o.w, o.itemW = o.minW > o.w ? (o.w - e * (n - 1)) / n : o.maxW < o.w ? (o.w - e * (i - 1)) / i : o.vars.itemWidth > o.w ? o.w : o.vars.itemWidth, o.visible = Math.floor(o.w / o.itemW), o.move = o.vars.move > 0 && o.vars.move < o.visible ? o.vars.move : o.visible, o.pagingCount = Math.ceil((o.count - o.visible) / o.move + 1), o.last = o.pagingCount - 1, o.limit = 1 === o.pagingCount ? 0 : o.vars.itemWidth > o.w ? o.itemW * (o.count - 1) + e * (o.count - 1) : (o.itemW + e) * o.count - o.w - e) : (o.itemW = o.w, o.itemM = e, o.pagingCount = o.count, o.last = o.count - 1), o.computedW = o.itemW - o.boxPadding, o.computedM = o.itemM
        }, o.update = function (t, e) {
            o.doMath(), h || (t < o.currentSlide ? o.currentSlide += 1 : t <= o.currentSlide && 0 !== t && (o.currentSlide -= 1), o.animatingTo = o.currentSlide), o.vars.controlNav && !o.manualControls && ("add" === e && !h || o.pagingCount > o.controlNav.length ? g.controlNav.update("add") : ("remove" === e && !h || o.pagingCount < o.controlNav.length) && (h && o.currentSlide > o.last && (o.currentSlide -= 1, o.animatingTo -= 1), g.controlNav.update("remove", o.last))), o.vars.directionNav && g.directionNav.update()
        }, o.addSlide = function (e, n) {
            var i = t(e);
            o.count += 1, o.last = o.count - 1, u && p ? void 0 !== n ? o.slides.eq(o.count - n).after(i) : o.container.prepend(i) : void 0 !== n ? o.slides.eq(n).before(i) : o.container.append(i), o.update(n, "add"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.added(o)
        }, o.removeSlide = function (e) {
            var n = isNaN(e) ? o.slides.index(t(e)) : e;
            o.count -= 1, o.last = o.count - 1, isNaN(e) ? t(e, o.slides).remove() : u && p ? o.slides.eq(o.last).remove() : o.slides.eq(e).remove(), o.doMath(), o.update(n, "remove"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.removed(o)
        }, g.init()
        ...
        if (void 0 === e && (e = {}), "object" == typeof e)return this.each(function () {
            ...
            1 === o.length && e.allowOneSlide === !1 || 0 === o.length ? (o.fadeIn(400), e.start && e.start(n)) : void 0 === n.data("flexslider") && new t.flexslider(this, e)
        });
    ...
    t.fn.fitVids = function (e) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            ...
            s.innerHTML = '<p>x</p><style id="fit-vids-style">' + o + "</style>", i.appendChild(s.childNodes[1])
        }
            ...
            o = o.not("object object"), o = o.not(i), o.each(function () {
                ...
                if (!(e.parents(i).length > 0 || "embed" === this.tagName.toLowerCase() && e.parent("object").length || e.parent(".fluid-width-video-wrapper").length)) {
                    ...
                    var n = "object" === this.tagName.toLowerCase() || e.attr("height") && !isNaN(parseInt(e.attr("height"), 10)) ? parseInt(e.attr("height"), 10) : e.height(),
                        o = isNaN(parseInt(e.attr("width"), 10)) ? e.width() : parseInt(e.attr("width"), 10), s = n / o;
                    if (!e.attr("name")) {
    ...
    function e() {
        t(window).width() === o && t(window).height() === s || (t(a).each(function () {
            t(this).flexMenu({undo: !0}).flexMenu(this.options)
        }), o = t(window).width(), s = t(window).height())
    }

    function n(e) {
        var n, i;
        n = t("li.flexMenu-viewMore.active"), i = n.not(e), i.removeClass("active").find("> ul").hide()
    }

    var i, o = t(window).width(), s = t(window).height(), a = [];
    t(window).resize(function () {
        clearTimeout(i), i = setTimeout(function () {
            e()
        }, 200)
    }), t.fn.flexMenu = function (e) {
        var i, o = t.extend({
            threshold: 2,
            cutoff: 2,
            linkText: "More",
        ...
        return this.options = o, i = t.inArray(this, a), i >= 0 ? a.splice(i, 1) : a.push(this), this.each(function () {
            function e(t) {
                var e = Math.ceil(t.offset().top) >= g + v;
                return e
            }

            var i, s, a, r, l, c, d, u = t(this), p = u.find("> li"), h = p.first(), f = p.last(),
                m = u.find("li").length, g = Math.floor(h.offset().top), v = Math.floor(h.outerHeight(!0)), y = !1;
            if (e(f) && m > o.threshold && !o.undo && u.is(":visible")) {
                var b = t('<ul class="flexMenu-popup" style="display:none;' + (o.popupAbsolute ? " position: absolute;" : "") + '"></ul>');
                for (b.addClass(o.popupClass), d = m; d > 1; d--) {
                    if (i = u.find("> li:last-child"), s = e(i), d - 1 <= o.cutoff) {
                        t(u.children().get().reverse()).appendTo(b), y = !0;
                        break
                    }
                    if (!s)break;
                    i.appendTo(b)
                }
                y ? u.append('<li class="flexMenu-viewMore flexMenu-allInPopup"><a href="#" title="' + o.linkTitleAll + '">' + o.linkTextAll + "</a></li>") : u.append('<li class="flexMenu-viewMore"><a href="#" title="' + o.linkTitle + '">' + o.linkText + "</a></li>"), a = u.find("> li.flexMenu-viewMore"), e(a) && u.find("> li:nth-last-child(2)").appendTo(b), b.children().each(function (t, e) {
                    b.prepend(e)
                }), a.append(b), r = u.find("> li.flexMenu-viewMore > a"), r.click(function (t) {
                    n(a), b.toggle(), a.toggleClass("active"), t.preventDefault()
                }), o.showOnHover && "undefined" != typeof Modernizr && !Modernizr.touch && a.hover(function () {
                    b.show(), t(this).addClass("active")
                }, function () {
                    b.hide(), t(this).removeClass("active")
                })
            } else if (o.undo && u.find("ul.flexMenu-popup")) {
                for (c = u.find("ul.flexMenu-popup"), l = c.find("li").length, d = 1; d <= l; d++)c.find("> li:first-child").appendTo(u);
                c.remove(), u.find("> li.flexMenu-viewMore").remove()
            }
        })
    }
}), !function (t) {
    ...
    var e, n, i, o, s, a, r = "Close", l = "BeforeClose", c = "AfterClose", d = "BeforeAppend", u = "MarkupParse",
        p = "Open", h = "Change", f = "mfp", m = "." + f, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close",
        b = function () {
        }, w = !!window.jQuery, C = t(window), _ = function (t, n) {
            e.ev.on(f + t + m, n)
        }, x = function (e, n, i, o) {
    ...
    b.prototype = {
        constructor: b, init: function () {
            ...
            if (n.isObj === !1) {
                ...
                var a, r = n.items;
                for (o = 0; o < r.length; o++)if (a = r[o], a.parsed && (a = a.el[0]), a === n.el[0]) {
                    e.index = o;
                    break
                }
            ...
            $("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (_(u, function (t, e, n, i) {
            ...
            }, 16), e.isOpen = !0, e.updateSize(d), $(p), n
        }, close: function () {
            ...
            if ($("BeforeChange", [e.currItem ? e.currItem.type : "", i]), e.currItem = n, !e.currTemplate[i]) {
                ...
                $("FirstMarkupParse", s), s ? e.currTemplate[i] = t(s) : e.currTemplate[i] = !0
            }
            o && o !== n.type && e.container.removeClass("mfp-" + o + "-holder");
            var a = e["get" + i.charAt(0).toUpperCase() + i.slice(1)](n, e.currTemplate[i]);
            e.appendContent(a, i), n.preloaded = !0, $(h, n), o = n.type, e.container.prepend(e.contentContainer), $("AfterChange")
        }, appendContent: function (t, n) {
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[n] === !0 ? e.content.find(".mfp-close").length || e.content.append(T()) : e.content = t : e.content = "", $(d), e.container.addClass("mfp-" + n + "-holder"), e.contentContainer.append(e.content)
        }, parseEl: function (n) {
            var i, o = e.items[n];
            ...
            var o;
            i.data && (n = t.extend(i.data, n)), $(u, [e, n, i]), t.each(n, function (n, i) {
                if (void 0 === i || i === !1)return !0;
                if (o = n.split("_"), o.length > 1) {
                    var s = e.find(m + "-" + o[0]);
                    if (s.length > 0) {
                        var a = o[1];
                        "replaceWith" === a ? s[0] !== i[0] && s.replaceWith(i) : "img" === a ? s.is("img") ? s.attr("src", i) : s.replaceWith(t("<img>").attr("src", i).attr("class", s.attr("class"))) : s.attr(o[1], i)
                    }
        ...
        if ("string" == typeof n)if ("open" === n) {
            var o, s = w ? i.data("magnificPopup") : i[0].magnificPopup, a = parseInt(arguments[1], 10) || 0;
            s.items ? o = s.items[a] : (o = i, s.delegate && (o = o.find(s.delegate)), o = o.eq(a)), e._openClick({mfpEl: o}, i, s)
    ...
    var A, E, I, O = "inline", D = function () {
        I && (E.after(I.addClass(A)).detach(), I = null)
    };
            ...
            initInline: function () {
                ...
                if (D(), n.src) {
                    ...
                    if (s.length) {
                        ...
                        a && a.tagName && (E || (A = o.hiddenClass, E = x(A), A = "mfp-" + A), I = s.after(E).detach().removeClass(A)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(N, {
        options: {
            ...
            initAjax: function () {
                e.types.push(N), P = e.st.ajax.cursor, _(r + "." + N, j), _("BeforeChange." + N, j)
            }, getAjax: function (n) {
                P && t(document.body).addClass(P), e.updateStatus("loading");
                var i = t.extend({
                    url: n.src, success: function (i, o, s) {
                        var a = {data: i, xhr: s};
                        $("ParseAjax", a), e.appendContent(t(a.data), N), n.finished = !0, M(), e._setFocus(), setTimeout(function () {
                            e.wrap.addClass(g)
            ...
            initImage: function () {
                ...
                var n = 0, i = t.img[0], o = function (s) {
                    L && clearInterval(L), L = setInterval(function () {
                        return i.naturalWidth > 0 ? void e._onImageHasSize(t) : (n > 200 && clearInterval(L), n++, void(3 === n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)))
                    }, s)
                };
                o(1)
            }, getImage: function (n, i) {
                var o = 0, s = function () {
                    n && (n.img[0].complete ? (n.img.off(".mfploader"), n === e.currItem && (e._onImageHasSize(n), e.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, $("ImageLoadComplete")) : (o++, o < 200 ? setTimeout(s, 100) : a()))
                }, a = function () {
                ...
                if (l.length) {
                    ...
                    c.className = "mfp-img", n.el && n.el.find("img").length && (c.alt = n.el.find("img").attr("alt")), n.img = t(c).on("load.mfploader", s).on("error.mfploader", a), c.src = n.src, l.is("img") && (n.img = n.img.clone()), c = n.img[0], c.naturalWidth > 0 ? n.hasSize = !0 : c.width || (n.hasSize = !1)
                }
                return e._parseMarkup(i, {
                    title: q(n),
                    img_replaceWith: n.img
                }, n), e.resizeImage(), n.hasSize ? (L && clearInterval(L), n.loadError ? (i.addClass("mfp-loading"), e.updateStatus("error", r.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), e.updateStatus("ready")), i) : (e.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), e.findImageSize(n)), i)
            }
        }
    });
    var z, R = function () {
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (n.enabled && e.supportsTransition) {
                    var o, s, a = n.duration, c = function (t) {
                            ...
                            s = c(t), s.css(e._getOffset()), e.wrap.append(s), o = setTimeout(function () {
                                s.css(e._getOffset(!0)), o = setTimeout(function () {
                                    d(), setTimeout(function () {
                                        s.remove(), t = s = null, $("ZoomAnimationEnded")
                                    }, 16)
                                }, a)
                            }, 16)
                        }
                ...
                var r = {width: i.width(), height: (w ? i.innerHeight() : i[0].offsetHeight) - a - s};
                return R() ? r["-moz-transform"] = r.transform = "translate(" + o.left + "px," + o.top + "px)" : (r.left = o.left, r.top = o.top), r
            }
        }
    });
    var H = "iframe", U = "//about:blank", W = function (t) {
        if (e.currTemplate[H]) {
    ...
    t.magnificPopup.registerModule(H, {
        options: {
            ...
            initIframe: function () {
                e.types.push(H), _("BeforeChange", function (t, e, n) {
                    e !== n && (e === H ? W() : n === H && W(!0))
                }), _(r + "." + H, function () {
                    W()
                })
    ...
    t.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                return e.direction = !0, !(!n || !n.enabled) && (s += " mfp-gallery", _(p + o, function () {
        ...
        options: {
            ...
            initRetina: function () {
                if (window.devicePixelRatio > 1) {
                    ...
                    n = isNaN(n) ? n() : n, n > 1 && (_("ImageHasSize." + Q, function (t, e) {
                        e.img.css({"max-width": e.img[0].naturalWidth / n, width: "100%"})
                    }), _("ElementParse." + Q, function (e, i) {
        ...
        return function () {
            if (!e || !e.requirejs) {
                ...
                !function (e) {
                    ...
                    function s(t, e) {
                        var n, i, o, s, a, r, l, c, d, u, p, h = e && e.split("/"), f = y.map, m = f && f["*"] || {};
                        if (t && "." === t.charAt(0))if (e) {
                            for (t = t.split("/"), a = t.length - 1, y.nodeIdCompat && _.test(t[a]) && (t[a] = t[a].replace(_, "")), t = h.slice(0, h.length - 1).concat(t), d = 0; d < t.length; d += 1)if (p = t[d], "." === p) t.splice(d, 1), d -= 1; else if (".." === p) {
                        ...
                        if ((h || m) && f) {
                            for (n = t.split("/"), d = n.length; d > 0; d -= 1) {
                                if (i = n.slice(0, d).join("/"), h)for (u = h.length; u > 0; u -= 1)if (o = f[h.slice(0, u).join("/")], o && (o = o[i])) {
                                    s = o, r = d;
                                    break
                                }
                                if (s)break;
                            ...
                            !s && l && (s = l, r = c), s && (n.splice(0, r, s), t = n.join("/"))
                        }
                        return t
                    }
                    ...
                    var p, h, f, m, g = {}, v = {}, y = {}, b = {}, w = Object.prototype.hasOwnProperty, C = [].slice,
                        _ = /\.js$/;
                    f = function (t, e) {
                        var n, i = d(t), o = i[0];
                        return t = i[1], o && (o = s(o, e), n = c(o)), o ? t = n && n.normalize ? n.normalize(t, r(e)) : s(t, e) : (t = s(t, e), i = d(t), o = i[0], t = i[1], o && (n = c(o))), {
                            f: o ? o + "!" + t : t,
                            n: t,
                            pr: o,
                            p: n
                        ...
                        var r, d, u, p, h, y, w = [], C = typeof i;
                        if (s = s || t, "undefined" === C || "function" === C) {
                            for (n = !n.length && i.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1)if (p = f(n[h], s), d = p.f, "require" === d) w[h] = m.require(t); else if ("exports" === d) w[h] = m.exports(t), y = !0; else if ("module" === d) r = w[h] = m.module(t); else if (o(g, d) || o(v, d) || o(b, d)) w[h] = c(d); else {
                                if (!p.p)throw new Error(t + " missing " + d);
                                p.p.load(p.n, a(s, !0), l(d), {}), w[h] = g[d]
                            }
                            u = i ? i.apply(g[t], w) : void 0, t && (r && r.exports !== e && r.exports !== g[t] ? g[t] = r.exports : u === e && y || (g[t] = u))
                        } else t && (g[t] = i)
                    }, t = n = h = function (t, n, i, o, s) {
                        ...
                        e.splice || (n = e, e = []), o(g, t) || o(v, t) || (v[t] = [t, e, n])
                    }, i.amd = {jQuery: !0}
            ...
            return e.Extend(n, e.Observable), n.prototype.render = function () {
                ...
                if (e.children) {
                    var a = t(n), r = document.createElement("strong");
                ...
                this.$results.attr("id", o), e.on("results:all", function (t) {
                    ...
                    if (0 !== n) {
                        ...
                        var a = i.$results.offset().top, r = s.offset().top, l = i.$results.scrollTop() + (r - a);
                        0 === o ? i.$results.scrollTop(0) : r - a < 0 && i.$results.scrollTop(l)
                    }
                    ...
                    if (!(o >= e.length)) {
                        ...
                        var a = i.$results.offset().top + i.$results.outerHeight(!1),
                            r = s.offset().top + s.outerHeight(!1), l = i.$results.scrollTop() + r - a;
                        0 === o ? i.$results.scrollTop(0) : r > a && i.$results.scrollTop(l)
                    }
                ...
                if (0 !== t.length) {
                    var e = this.$results.find("[aria-selected]"), n = e.index(t), i = this.$results.offset().top,
                        o = t.offset().top, s = this.$results.scrollTop() + (o - i), a = o - i;
                    s -= 2 * t.outerHeight(!1), n <= 2 ? this.$results.scrollTop(0) : (a > this.$results.outerHeight() || a < 0) && this.$results.scrollTop(s)
                }
            ...
            return n.Extend(i, e), i.prototype.render = function () {
                ...
                if (this.clear(), 0 !== t.length) {
                    for (var e = [], i = 0; i < t.length; i++) {
                        var o = t[i], s = this.selectionContainer(), a = this.display(o, s);
                        s.append(a), s.prop("title", o.title || o.text), s.data("data", o), e.push(s)
                    }
            ...
            return e.prototype.bind = function (e, n, i) {
                ...
                e.call(this, n, i), n.on("*", function (e, n) {
                    if (t.inArray(e, s) !== -1) {
                        ...
                        o.$element.trigger(i), t.inArray(e, a) !== -1 && (n.prevented = i.isDefaultPrevented())
                    }
                })
            }, e
            ...
            return e.Extend(i, t), i.prototype.current = function (t) {
                ...
                if (this.$element.prop("multiple"))return t.selected = !1, n(t.element).is("option") ? (t.element.selected = !1, void this.$element.trigger("change")) : void this.current(function (i) {
                    for (var o = [], s = 0; s < i.length; s++) {
                        var a = i[s].id;
                        a !== t.id && n.inArray(a, o) === -1 && o.push(a)
                    }
                    e.$element.val(o), e.$element.trigger("change")
                })
            }, i.prototype.bind = function (t, e) {
                ...
                s.each(function () {
                    ...
                    if (e.is("option") || e.is("optgroup")) {
                        var s = o.item(e), a = o.matches(t, s);
                        null !== a && i.push(a)
                    }
                }), e({results: i})
            ...
            return e.Extend(i, t), i.prototype.select = function (t) {
                ...
                for (var o = this, s = this.$element.find("option"), a = s.map(function () {
                    ...
                    if (n.inArray(c.id, a) >= 0) {
                        var d = s.filter(i(c)), u = this.item(d), p = n.extend(!0, {}, c, u), h = this.option(p);
                        d.replaceWith(h)
                    } else {
                        var f = this.option(c);
                        if (c.children) {
            ...
            function e(e, n, i) {
                ...
                if (void 0 !== a && (this.insertTag = a), e.call(this, n, i), t.isArray(o))for (var r = 0; r < o.length; r++) {
                    var l = o[r], c = this._normalizeItem(l), d = this.option(c);
            ...
            return e.prototype.query = function (t, e, n) {
                function i(t, s) {
                    for (var a = t.results, r = 0; r < a.length; r++) {
                        var l = a[r], c = null != l.children && !i({results: l.children}, !0), d = l.text === e.term;
                        if (d || c)return !s && (t.data = a, void n(t))
                    }
                    if (s)return !0;
                    var u = o.createTag(e);
                    if (null != u) {
                        var p = o.option(u);
                        p.attr("data-select2-tag", !0), o.addOptions([p]), o.insertTag(a, u)
                    }
                    t.results = a, n(t)
                }
            ...
            return e.prototype.bind = function (t, e, n) {
                ...
                function o(e) {
                    var n = a._normalizeItem(e), i = a.$element.find("option").filter(function () {
                ...
                var a = this;
                n.term = n.term || "";
                var r = this.tokenizer(n, this.options, o);
                ...
                for (var s = i.get("tokenSeparators") || [], a = n.term, r = 0, l = this.createTag || function (t) {
                        return {id: t.term, text: t.term}
                    }; r < a.length;) {
                    var c = a[r];
                    if (t.inArray(c, s) !== -1) {
                        var d = a.substr(0, r), u = t.extend({}, n, {term: d}), p = l(u);
            ...
            return n.prototype.bind = function (t, e, n) {
                ...
                var o = this, s = "scroll.select2." + i.id, a = "resize.select2." + i.id,
                ...
                }), t(window).on(s + " " + a + " " + r, function (t) {
                    o._positionDropdown(), o._resizeDropdown()
                })
            }, n.prototype._detachPositioningHandler = function (n, i) {
                var o = "scroll.select2." + i.id, s = "resize.select2." + i.id, a = "orientationchange.select2." + i.id,
                    r = this.$container.parents().filter(e.hasScroll);
                r.off(o), t(window).off(o + " " + s + " " + a)
            ...
            E.prototype.apply = function (u) {
                ...
                if (null == u.resultsAdapter && (u.resultsAdapter = n, null != u.ajax && (u.resultsAdapter = c.Decorate(u.resultsAdapter, x)), null != u.placeholder && (u.resultsAdapter = c.Decorate(u.resultsAdapter, _)), u.selectOnClose && (u.resultsAdapter = c.Decorate(u.resultsAdapter, S))), null == u.dropdownAdapter) {
                    if (u.multiple) u.dropdownAdapter = w; else {
                        var I = c.Decorate(w, C);
                        u.dropdownAdapter = I
                    }
                ...
                if (null == u.selectionAdapter) {
                    if (u.multiple ? u.selectionAdapter = o : u.selectionAdapter = i, null != u.placeholder && (u.selectionAdapter = c.Decorate(u.selectionAdapter, s)), u.allowClear && (u.selectionAdapter = c.Decorate(u.selectionAdapter, a)), u.multiple && (u.selectionAdapter = c.Decorate(u.selectionAdapter, r)), null != u.containerCssClass || null != u.containerCss || null != u.adaptContainerCssClass) {
                ...
                if (t.isArray(u.language)) {
                    ...
                    for (var j = u.language, L = 0; L < j.length; L++) {
                        ...
                        try {
                            ...
                            try {
                                q = this.defaults.amdLanguageBase + q, z = d.loadPath(q)
                            } catch (t) {
                    ...
                    var R = d.loadPath(this.defaults.amdLanguageBase + "en"), H = new d(u.language);
                    H.extend(R), u.translations = H
                }
                return u
                ...
                function n(i, o) {
                    ...
                    if (o.children && o.children.length > 0) {
                        for (var s = t.extend(!0, {}, o), a = o.children.length - 1; a >= 0; a--) {
                            var r = o.children[a], l = n(i, r);
                            null == l && s.children.splice(a, 1)
                        }
                        return s.children.length > 0 ? s : n(i, s)
                    }
                    var c = e(o.text).toUpperCase(), d = e(i.term).toUpperCase();
            ...
            return o.prototype.fromElement = function (t) {
                ...
                var s = e.extend(!0, {}, o);
                s = i._convertData(s);
                for (var a in s)e.inArray(a, n) > -1 || (e.isPlainObject(this.options[a]) ? e.extend(this.options[a], s[a]) : this.options[a] = s[a]);
                return this
            ...
            return n.Extend(o, n.Observable), o.prototype._generateId = function (t) {
                ...
                if ("style" == e) {
                    ...
                    for (var a = s.split(";"), r = 0, l = a.length; r < l; r += 1) {
                        var c = a[r].replace(/\s/g, ""), d = c.match(n);
                ...
                if (void 0 === e && (e = {}), t in i) {
                    var s = i[t], a = {prevented: !1, name: t, args: e};
                    if (n.call(this, s, a), a.prevented)return void(e.prevented = !0)
                }
                n.call(this, t, e)
            ...
            function e(e, n, i) {
                ...
                o = t.trim(e.attr("class")), o && (o = "" + o, t(o.split(/\s+/)).each(function () {
                    ...
                    0 !== this.indexOf("select2-") && (s = i(this), null != s && a.push(s))
                })), e.attr("class", a.join(" "))
            }
            ...
            return i.prototype.render = function (i) {
                var o = i.call(this), s = this.options.get("containerCssClass") || "";
                t.isFunction(s) && (s = s(this.$element));
                var a = this.options.get("adaptContainerCssClass");
                if (a = a || n, s.indexOf(":all:") !== -1) {
                    s = s.replace(":all:", "");
                    var r = a;
                    a = function (t) {
                        var e = r(t);
                ...
                return t.isFunction(l) && (l = l(this.$element)), e.syncCssClasses(o, this.$element, a), o.css(l), o.addClass(s), o
            }, i
            ...
            return i.prototype.render = function (i) {
                var o = i.call(this), s = this.options.get("dropdownCssClass") || "";
                t.isFunction(s) && (s = s(this.$element));
            ...
            return e.prototype.current = function (e, n) {
                function i(e, n) {
                    var o = [];
                    return e.selected || t.inArray(e.id, n) !== -1 ? (e.selected = !0, o.push(e)) : e.selected = !1, e.children && o.push.apply(o, i(e.children, n)), o
                }

                for (var o = [], s = 0; s < this._currentData.length; s++) {
                    var a = this._currentData[s];
                    o.push.apply(o, i(a, this.$element.val().split(this._valueSeparator)))
                }
                n(o)
                ...
                for (var i = [], o = 0; o < this._currentData.length; o++) {
                    var s = this._currentData[o], a = this.matches(e, s);
                    null !== a && i.push(a)
                }
                n({results: i})
                ...
                function n(n, i) {
                    ...
                    if (i.children) {
                        for (var s = i.children.length - 1; s >= 0; s--) {
                            var a = i.children[s], r = e(n.term, a.text, a);
                            r || o.children.splice(s, 1)
                        }
            ...
            function e(e) {
                var a = e || window.event, r = l.call(arguments, 1), c = 0, u = 0, p = 0, h = 0, f = 0, m = 0;
                if (e = t.event.fix(a), e.type = "mousewheel", "detail" in a && (p = a.detail * -1), "wheelDelta" in a && (p = a.wheelDelta), "wheelDeltaY" in a && (p = a.wheelDeltaY), "wheelDeltaX" in a && (u = a.wheelDeltaX * -1), "axis" in a && a.axis === a.HORIZONTAL_AXIS && (u = p * -1, p = 0), c = 0 === p ? u : p, "deltaY" in a && (p = a.deltaY * -1, c = p), "deltaX" in a && (u = a.deltaX, 0 === p && (c = u * -1)), 0 !== p || 0 !== u) {
                    if (1 === a.deltaMode) {
                    ...
                    if (h = Math.max(Math.abs(p), Math.abs(u)), (!s || h < s) && (s = h, i(a, h) && (s /= 40)), i(a, h) && (c /= 40, u /= 40, p /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / s), u = Math[u >= 1 ? "floor" : "ceil"](u / s), p = Math[p >= 1 ? "floor" : "ceil"](p / s), d.settings.normalizeOffset && this.getBoundingClientRect) {
                        var y = this.getBoundingClientRect();
                        f = e.clientX - y.left, m = e.clientY - y.top
                    }
                    return e.deltaX = u, e.deltaY = p, e.deltaFactor = s, e.offsetX = f, e.offsetY = m, e.deltaMode = 0, r.unshift(e, c, u, p), o && clearTimeout(o), o = setTimeout(n, 200), (t.event.dispatch || t.event.handle).apply(this, r)
                }
            }
    ...
    t.expr[":"].onScreen = function (e) {
        var n = t(window), i = n.scrollTop(), o = n.height(), s = i + o, a = t(e), r = a.offset().top, l = a.height(),
            c = r + l;
        return r >= i && r < s || c > i && c <= s || l > o && r <= i && c >= s
    }
}(jQuery), function (t) {
    jQuery(document).ready(function (t) {
        t(window).on("load", function () {
            ...
            t("body").removeClass("loading")
        }, 8e3), t(".pagesidebar .sidemenu li.menu-item-has-children").each(function () {
            var e = t(this);
            e.on("click", function (t) {
                e.hasClass("active") ? (e.removeClass("active"), e.find("> ul.sub-menu").hide(200)) : (e.find("> ul.sub-menu").show(200), e.addClass("active")), t.stopPropagation()
            })
        }), t(".global #trigger").on("click", function (e) {
            e.preventDefault(), t(".global").hasClass("open") ? t(".global").removeClass("open") : (t(".global").addClass("open"), t("body").trigger("global_opened")), e.stopPropagation()
        }), t("#logo img").each(function () {
            t(this).attr("width", t(this).width()), t(this).attr("height", t(this).height())
        }), t(".global #login_trigger").on("click", function (e) {
            e.preventDefault(), t(".global").hasClass("login_open") ? t(".global").removeClass("login_open") : (t(".global").addClass("login_open"), t("body").trigger("global_opened")), e.stopPropagation()
        }), t("body").on("global_opened", function () {
            t(document).on("click", ".pusher", function (e) {
                t(".global").hasClass("open") && t(".global").removeClass("open"), t(".global").hasClass("login_open") && t(".global").removeClass("login_open")
            }), t("#close_menu_sidebar").on("click", function (e) {
                e.preventDefault(), t(".global").removeClass("open")
            })
        }), t("nav .menu-item").has(".sub-menu").each(function () {
            if (t(this).find(".megadrop").length > 0) {
                t(this).addClass("hasmegamenu");
                var e = t(this).find(".megadrop").attr("data-width");
                "undefined" != typeof e && e !== !1 && t(this).find(".sub-menu").first().css("width", e)
            }
        }), t("section#content .vibe_editor").each(function () {
            t(this).children().length || t(this).parent().parent().addClass("no-content")
        }), t(document).on("click", ".vbplogin", function (e) {
            e.preventDefault(), t("#vibe_bp_login").hasClass("active") ? (t("#vibe_bp_login").hide(), t("#vibe_bp_login").removeClass("active")) : (t("#vibe_bp_login").fadeIn(300), t("#vibe_bp_login").addClass("active")), e.stopPropagation()
        }), t("#new_searchicon,#mobile_searchicon").click(function (e) {
            t("body").addClass("search_active")
        }), t("#close_full_popup").click(function (e) {
            t("#vibe_bp_login").fadeOut(300), t("#vibe_bp_login").removeClass("active")
        }), t("#searchdiv span").on("click", function () {
            t("body").removeClass("search_active")
        }), t(document).mouseup(function (e) {
            container = t("#searchdiv"), "searchdiv" == t(e.target).attr("id") && t("body").removeClass("search_active"), container = t("#vibe_bp_login"), container.is(e.target) || 0 !== container.has(e.target).length || t(e.target).hasClass("vbplogin") || t(e.target).closest(".vbplogin").length || (container.hide(), t("#vibe_bp_login").removeClass("active"))
        }), t("#headernotification").each(function () {
            var e = t.cookie("closed");
            null !== e && "headernotification" == e && t(this).hide()
        }), t(".commentratingbox").each(function () {
            t(this).rating()
        }), t("#widget-tabs a").click(function (e) {
            e.preventDefault(), "function" == typeof t().tab && t(this).tab("show")
        }), t("#footernotification").each(function () {
            var e = t.cookie("closed");
            null !== e && "footernotification" == e && t(this).hide();
        }), t(".close").click(function () {
            var e = t(this).parent().parent(), n = e.attr("id");
            e.hide(200), t.cookie("closed", n, {expires: 2, path: "/"})
        }), jQuery("#scrolltop a").click(function (e) {
            return e.preventDefault(), t("body,html").animate({scrollTop: 0}, 1200), !1
        }), t("body").delegate(".woocommerce-error", "click", function (e) {
            t(e.target).is("a") || (e.preventDefault(), t(this).fadeOut(200))
        }), "function" == typeof t().tooltip && (t(".tip").tooltip(), t(".nav-tabs li:first a").tab("show")), t(".course_description").on("click", "#more_desc", function (e) {
            e.preventDefault(), t(this).fadeOut("fast"), t(".full_desc").fadeIn("fast")
        }), t(".course_description").on("click", "#less_desc", function (e) {
            e.preventDefault(), t(".full_desc").fadeOut("fast"), t("#more_desc").fadeIn("fast")
        }), t("#signup_password, #account_password").each(function () {
            function e(t, e) {
                var n = 0;
                return t.length < 6 ? (e.removeClass(), e.addClass("short"), BP_DTheme.too_short) : (t.length > 7 && (n += 1), t.match(/([a-z].*[A-Z])|([A-Z].*[a-z])/) && (n += 1), t.match(/([a-zA-Z])/) && t.match(/([0-9])/) && (n += 1), t.match(/([!,%,&,@,#,$,^,*,?,_,~])/) && (n += 1), t.match(/(.*[!,%,&,@,#,$,^,*,?,_,~].*[!,%,&,@,#,$,^,*,?,_,~])/) && (n += 1), n < 2 ? (e.removeClass(), e.addClass("weak"), BP_DTheme.weak) : 2 == n ? (e.removeClass(), e.addClass("good"), BP_DTheme.good) : (e.removeClass(), e.addClass("strong"), BP_DTheme.strong))
            }

            var n, i = t(this);
            n = t(t(this).hasClass("form_field") ? 'label[for="signup_password"]' : 'label[for="account_password"]'), t(this).keyup(function () {
                n.find("span").length ? n.find("span").html(e(i.val(), n)) : n.append("<span>" + e(i.val(), n) + "</span>")
            })
        })
    }), jQuery(document).ready(function (t) {
        if (t(".chosen,select[multiple]").each(function () {
                t(this).hasClass("select2-hidden-accessible") || t(this).select2({allowClear: !0})
            }), t("header.sleek").hasClass("transparent") || t("header").hasClass("generic")) {
            var e, n = t("header:first").height() + 30, i = t("header:first");
            t("body").hasClass("page-template-contact-php") ? e = 0 : t("body").hasClass("bp-user") && (t("body").hasClass("p2") || t("body").hasClass("p3") || t("body").hasClass("p4") || t("body").hasClass("modern-theme")) ? e = t("#item-header") : t("body").hasClass("groups") && t("body").hasClass("single-item") && (t("body").hasClass("g2") || t("body").hasClass("g3")) || t("body").hasClass("single-item") && t("body").hasClass("modern-theme") && !t("body").hasClass("g4") ? e = t("#item-header") : t("body").hasClass("single-course") && (t("body").hasClass("c2") || t("body").hasClass("c3") || t("body").hasClass("c5")) || t("body").hasClass("single-course") && t("body").hasClass("modern-theme") && !t("body").hasClass("c4") ? e = t("#item-header") : t("body").hasClass("activity-permalink") ? (i.after('<div id="title"></div>'), e = t("#title")) : (e = i.next(), e.is(":visible") || (e = i.next().next())), e && (e.css("padding-top", n + "px"), e.addClass("light"))
        }
        t("header").hasClass("mooc") && t("#mooc_searchform").click(function (e) {
            var n = e.target;
            t(n).is("input") || t(this).find(".search_form").toggleClass("active")
        });
        var o = t(window).height();
        t("body #content,body.activity-permalink.single .activity").each(function () {
            var e = t(this), n = 0;
            t("#footerbottom").length && (n = t("#footerbottom").offset().top, n += t("#footerbottom").height(), n < o && (0 != t(document).find(".main,body.activity-permalink.single .activity").length ? t(".main,body.activity-permalink.single .activity").last().css("padding-bottom", o - n + "px") : e.css("padding-bottom", o - n + "px")))
        }), t(window).scroll(function (e) {
            var n = t(this).scrollTop();
            if (t("#headertop").hasClass("fix")) {
                var i = t("header").height();
                n > i ? t("#headertop").addClass("fixed") : t("#headertop").removeClass("fixed")
            }
            if (t("header.sleek").hasClass("fix") || t("header.generic").hasClass("fix")) {
                var s = t("header.fix"), i = parseInt(t("header.fix").height()), a = "";
                i += 30, t("body").hasClass("page-template-contact-php") ? a = "" : t("body").hasClass("bp-user") && (t("body").hasClass("p2") || t("body").hasClass("p3") || t("body").hasClass("p4")) ? a = t("#item-header") : t("body").is(".groups, .single-item") && (t("body").hasClass("g2") || t("body").hasClass("g3")) ? a = t("#item-header") : t("body").hasClass("single-course") && (t("body").hasClass("c2") || t("body").hasClass("c3") || t("body").hasClass("c5")) || t("body").hasClass("single-course") && t("body").hasClass("modern-theme") && !t("body").hasClass("c4") ? a = t("#item-header") : (a = s.next(), a.is(":visible") || (a = s.next().next())), n > i ? (t("header.fix").addClass("fixed"), s.hasClass("fixed") && a && a.css("padding-top", i + "px")) : (t("header.fix").removeClass("fixed"), s.hasClass("transparent") || s.hasClass("generic") || a && a.css("padding-top", ""))
            }
            if (t("header.standard,header.mooc").hasClass("fix")) {
                var s = t(this), i = t("header.fix").height();
                n > i ? t("header.fix").addClass("fixed") : t("header.fix").removeClass("fixed")
            }
            n > o ? t("#scrolltop").addClass("fix") : t("#scrolltop").removeClass("fix")
        }), t(".twitter_carousel").each(function () {
            var e = t(this);
            e.flexslider({
                animation: "slide",
                controlNav: !1,
        ...
        }), t("body").hasClass("modern-theme") || t(".bp-user.p2 #object-nav,.bp-user.p3 #object-nav,.bp-user.p4 #object-nav,.single-items.groups #object-nav,.single-course.c2 #object-nav,.single-course.c3 #object-nav,.single-course.c4 #object-nav,.single-course.c5 #object-nav").each(function () {
            t(this).find("ul").flexMenu({
                linkText: wplms.more,
                linkTitle: wplms.view_more,
                linkTextAll: wplms.menu,
                linkTitleAll: wplms.open_menu
            })
        }), t(".certifications").flexslider({
            animation: "slide",
            controlNav: !1,
            directionNav: !0,
            animationLoop: !0,
            ...
            prevText: "<i class='icon-arrow-1-left'></i>",
            nextText: "<i class='icon-arrow-1-right'></i>"
        }), t(".vbpcart").on("click", function (e) {
            e.preventDefault(), t(this).toggleClass("active"), t(".woocart").toggleClass("active")
        })
    }), jQuery(document).ready(function (t) {
        t(".v_parallax_block").each(function () {
            var e = t(this), n = parseInt(e.attr("data-scroll")), i = parseInt(e.attr("data-rev")),
                o = e.parent().position().top, s = parseInt(e.attr("data-adjust")), a = e.height(),
                r = e.find(".parallax_content").height();
            if (a < r && (a = r), 2 == i); else {
                var l = e.parent().parent();
                l.hasClass("stripe") && l.css("height", a + "px")
            }
            t(window).scroll(function (t) {
                t.preventDefault();
                var a, r = jQuery(window), l = Math.round(r.scrollTop() / n);
                void 0 != i && (2 == i ? (l = Math.round((r.scrollTop() - o) / n), e.parent().css("-webkit-transform", "translateY(" + l + "px)"), e.parent().css("transform", "translateY(" + l + "px)")) : 1 == i ? (l -= s, a = "50% " + l + "px", e.css("background-position", a)) : (l = s - l, a = "50% " + l + "px", e.css("background-position", a)))
            })
        })
    }), jQuery(document).ready(function (t) {
        t("section.stripe").each(function () {
            var e = t(this).find(".v_column.stripe_container .v_module").attr("data-class");
            e && (e = "stripe " + e, t(this).find(".v_column.stripe .v_module").removeAttr("data-class"), t(this).attr("class", e));
            var e = t(this).find(".v_column.stripe .v_module").attr("data-class");
            e && (e = "stripe " + e, t(this).find(".v_column.stripe .v_module").removeAttr("data-class"), t(this).attr("class", e))
        }), t(".payment_methods.methods >li").click(function () {
            var e = t(this);
            t(".payment_methods.methods >li").find("div").hide(0, function () {
                e.find("div").show(0)
            })
        }), t("#prev_results a").on("click", function (e) {
            e.preventDefault(), t(this).toggleClass("show"), t(".prev_quiz_results").toggleClass("show")
        })
    }), jQuery(document).ready(function (t) {
        t("#filtercontainer").each(function () {
            var e = t("#filtercontainer"), n = {};
            e.isotope({itemSelector: ".filteritem"}), t(".filters a").click(function () {
                var i = t(this);
                if (!i.hasClass("active")) {
                    var o = i.parents(".option-set");
                    o.find(".active").removeClass("active"), i.addClass("active");
                    var s = o.attr("data-filter-group");
                    n[s] = i.attr("data-filter-value");
                    var a = [];
                    for (var r in n)a.push(n[r]);
                    var l = a.join("");
                    return e.isotope({filter: l}), !1
                }
            })
        })
    }), jQuery(document).ready(function (t) {
        t(".inmenu").each(function () {
            var e = t(".inmenu").offset().top - 40,
                n = t("footer").offset().top - Math.round(t(window).height() / 2) - 90;
            t(window).scroll(function () {
                var i = t(window).scrollTop();
                i > e && i < n ? t(".inmenu").addClass("affix") : t(".inmenu").removeClass("affix")
            })
        })
    }), jQuery(document).ready(function (t) {
        t(".scrollmenu").each(function () {
            var e, n = t(".scrollmenu"), i = 0, o = n.find("a"), s = o.map(function () {
                var e = t(t(this).attr("href"));
                if (e.length)return e
            });
            o.click(function (e) {
                e.preventDefault();
                var n = t(this).attr("href"), o = "#" === n ? 0 : t(n).offset().top - i + 1;
                t("html, body").stop().animate({scrollTop: o}, 800)
            }), t(window).scroll(function () {
                var n = t(this).scrollTop() + 25, i = s.map(function () {
                    if (t(this).offset().top < n)return this
                });
                i = i[i.length - 1];
                var a = i && i.length ? i[0].id : "";
                e !== a && (e = a, o.parent().removeClass("active"), o.filter("[href=#" + a + "]").parent().addClass("active")), t(".animate").filter(":onScreen").not(".load").each(function (e) {
                    var n = t(this), i = 100 * e, o = t(window).scrollTop(), s = o + t(window).height(),
                        a = n.offset().top;
        ...
        t(".minmax").click(function (e) {
            e.preventDefault(), t(this).parent().toggleClass("show"), t(this).find("i").toggleClass("icon-minus")
        })
    }), jQuery(document).ready(function (t) {
        t(".repeatablelist").each(function () {
            t(this).sortable({handle: ".sort_handle"})
        }), t(".add_repeatable").click(function () {
            var e = t(this).parent().find(".repeatablelist"),
                n = t(this).parent().find(".repeatablelist li:last-child"), i = n.clone(),
                o = i.find(".option_text").attr("rel-name");
            i.find(".option_text").attr("name", o), e.append(i)
        }), t(".print_results").click(function (e) {
            e.preventDefault(), t(".quiz_result").print()
        })
    }), jQuery(document).ready(function (t) {
        t("#login_modern_trigger").click(function () {
            t("#login-modal-overlay").addClass("show"), t("#login-modal").addClass("show")
        }), t("#close-modal").click(function () {
            t("#vibe_bp_login").removeClass("active"), t("#vibe_bp_login").hide()
        }), t(".action_control").on("click", function (e) {
            e.preventDefault();
            var n = t(this).parent().attr("class"), i = t("#content .unit_wrap");
            "fullscreen" == n && (alert("khaya"), i.requestFullscreen ? i.requestFullscreen() : i.mozRequestFullScreen ? i.mozRequestFullScreen() : i.webkitRequestFullscreen ? i.webkitRequestFullscreen() : i.msRequestFullscreen && i.msRequestFullscreen())
        }), t("#vbp-login-form").find("#wplms_forgot_password_form").length && (t("#sidebar-wp-submit").on("click", function (e) {
            e.preventDefault();
            var n = t(this);
            if (!n.hasClass("loading")) {
                n.addClass("loading");
                var i = n.closest("form");
                i.find(".message_wrap").remove();
                var o = {
                    user: i.find('input[type="text"]').val(),
                    pass: i.find('input[type="password"]').val(),
                    remember: i.find('input[type="checkbox"]:checked').val()
                };
                0 == i.find('input[type="text"]').val().length ? i.find('input[type="text"]').addClass("error") : i.find('input[type="text"]').removeClass("error"), 0 == i.find('input[type="password"]').val().length ? i.find('input[type="password"]').addClass("error") : i.find('input[type="text"]').removeClass("error"), t.ajax({
                    type: "POST",
                    url: ajaxurl,
                    dataType: "json",
                    data: {
                        action: "wplms_signon",
                        security: n.attr("data-security"),
                        redirect_to: document.URL,
                        data: JSON.stringify(o)
                    },
                    cache: !1,
                    success: function (t) {
                        console.log(t), "error" in t != 0 && (n.removeClass("loading"), n.after('<div class="message_wrap"><div class="message">' + t.error + "<span></span></div></div>"), "target" in t != 0 && i.find(t.target).addClass("error"), setTimeout(function () {
                            i.find(".message_wrap").remove()
                        }, 5e3)), "success" in t != 0 && (document.URL == t.success ? location.reload() : window.location.assign(t.success))
                    }
                })
            }
        }), t("#wplms_forgot_password_form").each(function () {
            t(".vbpforgot").on("click", function (e) {
                e.preventDefault(), t("#wplms_forgot_password_form").addClass("active");
                var n = t("#wplms_forgot_password_form").outerHeight();
                t(".inside_login_form").css("height", n + "px"), t(".md-content h3,.md-content .vbpregister").css("opacity", 0)
            })
        }), t(".back_to_login").on("click", function () {
            t("#vbp-login-form .active").removeClass("active"), t(".inside_login_form").removeAttr("style"), t(".md-content h3,.md-content .vbpregister").css("opacity", 1)
        }), t("#wplms_custom_registration_form").each(function () {
            t("#vbp-login-form .vbpregister").on("click", function (e) {
                e.preventDefault(), t("#wplms_custom_registration_form").addClass("active");
                var n = t("#wplms_custom_registration_form").outerHeight();
                t(".inside_login_form").css("height", n + "px"), t(".md-content h3,.md-content .vbpregister").css("opacity", 0)
            })
        })), t("#vbp_forgot_password").on("click", function (e) {
            e.preventDefault();
            var n = t(this);
            if (!n.hasClass("disabled")) {
                n.parent().find(".message_wrap").remove(), n.addClass("disabled");
                var i = n.parent().find('input[type="email"]').val(),
                    o = (n.text(), /^([a-z0-9._-]+@[a-z0-9._-]+\.[a-z]{2,4}$)/i);
                return i.match(o) ? void t.ajax({
                    type: "POST",
                    url: ajaxurl,
                    data: {action: "wplms_forgot_password", security: n.attr("data-security"), email: i},
                    cache: !1,
                    success: function (t) {
                        n.after('<div class="message_wrap"><div class="message">' + t + "<span></span></div></div>"), setTimeout(function () {
                            n.parent().find(".message_wrap").remove(), n.parent().find('input[type="email"]').val(""), n.removeClass("disabled")
                        }, 5e3)
                    }
                }) : (n.parent().find('input[type="email"]').addClass("error"), n.after('<div class="message_wrap"><div class="message">' + wplms.invalid_mail + "<span></span></div></div>"), void setTimeout(function () {
                    n.parent().find(".message_wrap").remove(), n.removeClass("disabled")
                }, 2e3))
            }
        }), t("body").delegate(".input", "keyup", function () {
            t(this).hasClass("error") && t(this).removeClass("error")
        }), t("body").delegate(".message_wrap .message > span", "click", function () {
            t(this).parent().parent().remove()
        })
    }), t(".course_packages_menu_before_title .burger_menu_wrapper").click(function () {
        t(this).find(".burger_menu").toggleClass("open"), t("body").toggleClass("course_packages_menu_show")
    }), t(".packaged_up_down").click(function () {
        t(".upload_course_content_header").toggleClass("hide_title")
    })
}(jQuery), !function (t) {
    t.fn.rating = function (e) {
        e = e || function () {
            }, this.each(function (n, i) {
            t(i).data("rating", {callback: e}).bind("init.rating", t.fn.rating.init).bind("set.rating", t.fn.rating.set).bind("hover.rating", t.fn.rating.hover).trigger("init.rating")
        })
    }, t.extend(t.fn.rating, {
        init: function (e) {
            for (var n = t(this), i = "", o = null, s = n.children(), a = 0,
                     r = s.length; a < r; a++)i = i + '<a class="star" title="' + t(s[a]).val() + '" />', t(s[a]).is(":checked") && (o = t(s[a]).val());
            s.hide(), n.append('<div class="stars">' + i + "</div>").trigger("set.rating", o), t("a", n).bind("click", t.fn.rating.click), n.trigger("hover.rating")
        }, set: function (e, n) {
            var i = t(this), o = t("a", i), s = void 0;
            n && (o.removeClass("fullStar"), s = o.filter(function (e) {
                return t(this).attr("title") == n && t(this)
            }), s.addClass("fullStar").prevAll().addClass("fullStar"))
        }, hover: function (e) {
            var n = t(this), i = t("a", n);
            i.bind("mouseenter", function (e) {
                t(this).addClass("tmp_fs").prevAll().addClass("tmp_fs"), t(this).nextAll().addClass("tmp_es")
            }), i.bind("mouseleave", function (e) {
                t(this).removeClass("tmp_fs").prevAll().removeClass("tmp_fs"), t(this).nextAll().removeClass("tmp_es")
            })
        }, click: function (e) {
            e.preventDefault();
            var n = t(e.target), i = n.parent().parent(), o = i.children("input"), s = n.attr("title");
            matchInput = o.filter(function (e) {
                return t(this).val() == s
            }), matchInput.attr("checked", !0).siblings("input").attr("checked", !1), i.trigger("set.rating", matchInput.val()).data("rating").callback(s, e)
        }
    })
}(jQuery);