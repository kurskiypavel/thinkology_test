    ...
    <div class="pusher">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <ul class="topmenu">
                            ...
                            if (function_exists('bp_loggedin_user_link') && is_user_logged_in()) :
                                ?>
                                <li><a href="<?php bp_loggedin_user_link(); ?>"
                                       class="smallimg vbplogin"><?php $n = vbp_current_user_notification_count();
                                ...
                                <li><a href="#login" rel="nofollow"
                                       class="smallimg vbplogin"><?php _e('Login', 'vibe'); ?></a></li>
                                <li><?php
            ...
            <div class="<?php echo vibe_get_container(); ?>" style="padding-left: 0px;padding-right: 0px;margin-right: 120px;margin-left: 0px;">
                <div class="row">
                    ...
                    <div class="col-md-4 left">
                        ...
                        <a href="<?php echo vibe_site_url('', 'side'); ?>"><img
                                    src="<?php echo apply_filters('wplms_logo_url', VIBE_URL . '/assets/images/logo.png', 'header'); ?>"
        ...
        <header class="standard center <?php if (isset($fix) && $fix) {
            ...
            <div class="<?php echo vibe_get_container(); ?>">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo vibe_site_url('', 'logo'); ?>" id="alt_logo"><img
                                    src="<?php echo apply_filters('wplms_logo_url', VIBE_URL . '/images/logo.png', 'standard_header'); ?>"
                                    alt="<?php echo get_bloginfo('name'); ?>"/></a>
                        <?php
