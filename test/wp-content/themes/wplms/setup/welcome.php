	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4>Site Import/Export & VC Integration </h4>
						<p>Major update with new features like site import and export. Using our inbuilt site export/importer you can export your installations among various setups and use our setup wizard to install.</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/3-2/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4>Site Import/Export</h4>
						<p>You now see a Export Wizard in WP Admin - Appearance - Export Wizard. On export you get a .zip file which can imported in any other WPLMS.</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-site-import-and-export/" class="button"><?php _e( 'Check tutorial', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4>Page Builder to Visual Composer Integration</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://s3.amazonaws.com/vt-tfimages/theme_welcome/VC_Vibebuilder.png">
						</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/vibe-page-builder-visual-composer-integration" target="_blank" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4>Child Themes in Setup Wizard</h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="https://s3.amazonaws.com/vt-tfimages/theme_welcome/child_themes.png" /></p>
					</div>
					<div>
						<h4>Child Themes in Demo Switcher</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://s3.amazonaws.com/vt-tfimages/theme_welcome/demo_switcher.png">
						</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-site-import-and-export/" target="_blank" class="button">Tutorial</a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					
					<div>
						<h4>Site Import wizard</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://s3.amazonaws.com/vt-tfimages/theme_welcome/wplms_import_wizard.png">
						</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-site-import-and-export/" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4>Export Wizard</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://s3.amazonaws.com/vt-tfimages/theme_welcome/export_wizard.png">
						</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-site-import-and-export/" target="_blank" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						...
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://s3.amazonaws.com/vt-tfimages/theme_welcome/wplms_documentation.png" />
						</p>
						<a href="https://vibethemes.github.io/wplms-docs" target="_blank" class="button">Documentation link</a>
					</div>
				</div>
			...
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4>WPLMS Custom Learning Paths</h4>
						<p>Creating custom paths for students to learn on the website.Learn something in a particular path and award certificates and badges for completing different steps.</p>
						<a href="<?php echo admin_url('admin.php?page=lms-settings&tab=addons'); ?>" class="button">Tutorial</a>
					</div>

					<div>
						<h4>Bigubluebutton Integration</h4>
						<p>A bbb addon has been released to integrate wplms with Bigbluebutton which provides online meetings,conferencing with students .</p>
						<a href="<?php echo admin_url('admin.php?page=lms-settings&tab=addons'); ?>" class="button">Tutorial</a>
					</div>
