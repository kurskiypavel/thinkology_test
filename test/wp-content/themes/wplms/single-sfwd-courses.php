                ...
                <div class="col-md-3 col-sm-3">
                    <div id="item-header" role="complementary">
                        ...
                        <div id="item-admins">
                            ...
                            <h5 class="course_instructor"><?php echo get_the_author_meta('display_name', $post->post_author); ?></h5>
                        </div><!-- #item-actions -->
                    ...
                    <div id="item-nav">
                        <div class="item-list-tabs no-ajax" id="object-nav" role="navigation">
                            <ul>
                                <li id="home" class="<?php echo(!isset($_GET['action']) ? 'selected' : ''); ?>"><a
                                            href="<?php echo get_permalink(); ?>"><?php _e('Home', 'vibe'); ?></a></li>
                                <li id="curriculum"
                                    class="<?php echo(($_GET['action'] == 'curriculum') ? 'selected' : ''); ?>"><a
                                            href="?action=curriculum"><?php _e('Curriculum', 'vibe'); ?></a></li>
                                <li id="members" class="<?php echo(($_GET['action'] == 'info') ? 'selected' : ''); ?>">
                                    <a href="?action=info"><?php _e('Course Info', 'vibe'); ?></a></li>
